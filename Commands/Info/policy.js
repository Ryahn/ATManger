  ...
  run: async (client, message, args) => {
    ...
    We never share your data with anyone except for [MongoDB Inc](https://mongodb.com) whom is a DataBase Company and all the data for our Bot is stored on the MongoDB Servers and According to MongoDB Inc. the data is only accessable by us.`
      ...
      .addField(
        ...
        `
    If you have any concerns or queries relating our privacy policy or our bot or if you want your data to be removed, You can contact [AinzOoalGown#3496](https://discord.com/users/72884988374167552) directy on our [Support Server](https://discord.gg/animetime)!`
      )
